...
function About() {
  return (
    <>
      ...
      >
        {/* <div style={{backgroundImage:`url(https://www.infosys.com/content/dam/infosys-web/en/global-resource/18/banner/future-work2023-thumb.jpg)`}}>
        ...
        <div className="p-5">
          ...
          <p className="text-black-500 leading-relaxed mb-6">
            Welcome to{" "}
            <span className="font-semibold text-blue-600">Pizza Planet</span> —
            where flavor meets passion! 🍕 We’re dedicated to crafting
            delicious, high-quality pizzas made from the freshest ingredients
            and baked to perfection. Our mission is to bring joy, one slice at a
            time, while maintaining the warmth of a local pizzeria and the
            efficiency of modern dining.
          </p>
          <div className="flex justify-center">
            <img alt="no image found" src="https://www.infosys.com/content/dam/infosys-web/en/global-resource/18/banner/future-work2023-thumb.jpg" />
          </div>
